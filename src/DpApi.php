...
class DpApi
{
	...
	{
		$results = $this->call('POST', '/kb/categories/' . intval($id), $params);
		return $this->_getSuccessResponse($results);
	}
	...
	{
		$results = $this->call('DELETE', '/kb/categories/' . intval($id));
		return $this->_getSuccessResponse($results);
	}
	...
	public function getArticleCategoryArticles($id, $page = 1, $order = null, $cache_id = null)
	{
		...
		$results = $this->call('GET', '/kb/categories/' . intval($id) . '/articles', $params);
		return $this->_getResponse($results);
	}
	...
	{
		$results = $this->call('GET', '/kb/categories/' . intval($id) . '/groups');
		return $this->_getResponse($results);
	}
	...
	public function addArticleCategoryGroup($category_id, $group_id)
	{
		...
		$results = $this->call('POST', '/kb/categories/' . intval($category_id) . '/groups', $params);
		return $this->_getResponse($results);
	}
	...
	{
		$results = $this->call('GET', '/kb/categories/' . intval($category_id) . '/groups/' . intval($group_id));
		return $this->_getExistsResponse($results);
	}
	...
	{
		$results = $this->call('DELETE', '/kb/categories/' . intval($category_id) . '/groups/' . intval($group_id));
		return $this->_getSuccessResponse($results);
	}
	...
	{
		$results = $this->call('GET', '/kb/fields');
		return $this->_getResponse($results);
	}
	...
	{
		$results = $this->call('GET', '/kb/products');
		return $this->_getResponse($results);
	}
	...
	public function getGlossaryWords($word = '')
	{
		...
		$results = $this->call('GET', '/glossary', $params);
		return $this->_getResponse($results);
	}
	...
	public function addGlossaryWord(array $words, $definition)
	{
		...
		$results = $this->call('POST', '/glossary', $params);
		return $this->_getResponse($results);
	}
	...
	{
		$params = array('word' => $word);
		$results = $this->call('GET', '/glossary/lookup', $params);
		return $this->_getResponse($results);
	}
	...
	{
		$results = $this->call('GET', '/glossary/' . intval($id));
		return $this->_getResponse($results);
	}
	...
	{
		$results = $this->call('DELETE', '/glossary/' . intval($id));
		return $this->_getSuccessResponse($results);
	}
	...
	{
		$results = $this->call('GET', '/glossary/definitions/' . intval($id));
		return $this->_getResponse($results);
	}
	...
	{
		$results = $this->call('POST', '/glossary/definitions/' . intval($id), $params);
		return $this->_getSuccessResponse($results);
	}

...
-----------------------------------
    ...
    $person->setName('Name of the Person creating the ticket')
            ->setEmail('Email of the Person creating the ticket')
            ->setOrganizationByName('Organization of the Person creating the ticket')
            ->setOrganizationPosition('Position of the Person creating the ticket');

    $ticket->setCreatedBy($person)
            ->setSubject('Subject of the new ticket')
